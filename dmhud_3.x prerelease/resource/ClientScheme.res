...
Scheme
{
	...
	Colors
	{
		...
		"dm_glass"					"244 244 244 25"
		"dm_darkglass"				"24 24 24 25"
		"dm_flavor"					"0 150 255 255"
		"dm_gray"					"140 140 140 255"
		"dm_darkgray"				"100 100 100 255"
		"dm_dullgray"				"200 200 200 255"
		"dm_caution"				"255 100 0 255"
		"menu_mouseover"			"0 150 255 40"
		...
		"dm_statbars"				"255 100 0 255" 	//Stats bars
		"dm_ammo"					"244 244 244 255"	//Ammo main color
		"dm_ammoreserve"			"0 255 255 255"		//Ammo clip
		"dm_lowammo"				"255 200 0 255"		//Low ammo
		"dm_lowammoFX"				"255 100 0 255"		//Low ammo flash
		"dm_health"					"244 244 244 255"	//First person health
		"dm_bonushealth"			"219 23 116 255"	//Health when buffed
		...
		"dm_timerPositive"			"0 255 255 255"		//timer additional time
		"dm_timerNegative"			"219 23 116 255"	//it's used??
		...
		"dm_damageDisplay"			"244 244 244 255"		//Damage.. duh
		...
		"dm_scoresLabels"			"244 244 244 255"
	...
	BaseSettings
	{
		...
		Econ.Button.PresetDefaultColorFg					"dm_text"
		Econ.Button.PresetArmedColorFg						"dm_darkgray"
		Econ.Button.PresetDepressedColorFg					"dm_caution"
		
		Econ.Button.PresetDefaultColorBg					"dm_gray"
		Econ.Button.PresetArmedColorBg						"dm_darkgray"
		Econ.Button.PresetDepressedColorBg					"dm_darkgray"
		
		Border.Bright					"Blank"		// the lit side of a control
		Border.Dark						"Black"		// the dark/unlit side of a control
		Border.Selection				"Gray"			// the additional border color for displaying the default/selected button

		Button.TextColor				"dm_text"
		Button.BgColor					"dm_white"
		Button.ArmedTextColor			"dm_text"
		Button.ArmedBgColor				"dm_dullgray"
		Button.SelectedTextColor		"dm_caution"
		Button.SelectedBgColor			"dm_dullgray"
		Button.DepressedTextColor		"dm_caution"
		Button.DepressedBgColor			"dm_dullgray"

		CheckButton.TextColor			"dm_text"
		CheckButton.SelectedTextColor	"dm_text"
		CheckButton.BgColor				"TransparentBlack"
		CheckButton.Border1  			"dm_caution" 		// the left checkbutton border
		CheckButton.Border2  			"dm_caution"		// the right checkbutton border
		CheckButton.Check				"dm_caution"		// color of the check itself
		CheckButton.HighlightFgColor	"dm_caution"
		...
		ProgressBar.FgColor				"dm_caution"
